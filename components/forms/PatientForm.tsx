...
const PatientForm: React.FC<PatientFormProps> = ({ user  }:{user:User}) =>{
...
const uploadFileToCloudinary = async (file: File) => {
  ...
  const response = await axios.post('https://api.cloudinary.com/v1_1/dqvskyeaf/image/upload', formData);
...
const onSubmit = async (values: z.infer<typeof PatientFormValidation>) => {
  ...
  try {
    ...
    formData.userid = user ? user._id : null;
