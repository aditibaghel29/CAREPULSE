...
interface RegisterFormProps {
  user: User | null; // Define the prop type
}
...
const RegisterForm: React.FC<RegisterFormProps> = ({ user }) =>{
  ...
  async function onSubmit(values: z.infer<typeof PatientFormValidation>) {
    console.log("Form Submitted"); // Check if submission is triggered
    ...
    try {
      ...
      if (values.identificationDocument instanceof File) {
        ...
        formData.append('file', values.identificationDocument);
      ...
      // Include the image URL in the form values
      const dataToSubmit = {
        ...values,
